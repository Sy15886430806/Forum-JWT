<template>
  <div style="text-align: center; margin: 0 20px">
      ...
      <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
        ...
        <el-form-item prop="code">
          <el-row :gutter="20">
            ...
            <el-col :span="5">
              <el-button type="primary" class="siyuan-button color-button" @click="validateEmail"
                         :disabled="!isEmailValid || codeTime">
                {{ codeTime > 0 ? `${codeTime} 秒可重试` : '获取验证码' }}
              </el-button>
            </el-col>
          </el-row>
        </el-form-item>
    ...
    <div class="grid-content ep-bg-purple" style="margin-top: 40px">
      <el-button @click="register" style="width: 150px" type="primary" class="siyuan-button color-button">立即注册
      </el-button>
    </div>
    <div style="margin-top: 20px ">
